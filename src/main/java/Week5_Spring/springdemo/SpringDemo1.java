...
public class SpringDemo1 {
    public static void main(String[] args) {
        ...
        System.out.println("student123 toString ============>" +student123.toString());

        student123.print();

        Student student100 = (Student) context.getBean("student123");
